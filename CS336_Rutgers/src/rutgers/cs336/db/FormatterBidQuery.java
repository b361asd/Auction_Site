...
public class FormatterBidQuery extends DBBase {
	...
	public static StringBuilder initQuerySearch() {
		...
		sb.append("SELECT bidID, offerID, buyer, price, autoRebidLimit, bidDate FROM Bid WHERE TRUE");
		//
		return sb;
	}
...
/*
SELECT bidID, offerID, buyer, price, autoRebidLimit, bidDate FROM Bid WHERE TRUE 
AND (buyer = 'user')
