<table>
	...
	<tr>
		...
		<th><A href="${pageContext.request.contextPath}/user/searchOffer.jsp">Search Offer To Bid</A></th>
		<th><A href="${pageContext.request.contextPath}/user/createOfferAlertCriterion.jsp">Setup Alert</A></th>
		<th><A href="${pageContext.request.contextPath}/user/listOfferAlertCriterion.jsp">Manage Alert Settings</A></th>
