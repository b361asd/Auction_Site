...
<h2><A href="${pageContext.request.contextPath}/user/postOffer.jspr.jsp">Post an Offer</A>
	<A href="${pageContext.request.contextPath}/user/postBid.jsp">Post a Bid</A>
	<A href="${pageContext.request.contextPath}/user/searchBid.jspd.jsp">Search Bids</A>
