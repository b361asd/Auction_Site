...
<table>
	<thead>
	<tr>
		<th><A href="${pageContext.request.contextPath}/admin/ReportTotalSales.jsp">Total Sales</A></th>
		<th><A href="${pageContext.request.contextPath}/admin/ReportSalesByCategoryName.jsp">Sales By Category</A></th>
		<th><A href="${pageContext.request.contextPath}/admin/ReportSalesByItemGroup.jsp">Sales Group By Similar</A></th>
