                ...
                if (addCol1st == 1) {
                    ...
                    if (_listActivity || _viewAlertDetail || _listMyBid) {
                        ...
                        if (!__userID.equalsIgnoreCase(_seller) && _status.equalsIgnoreCase("Active")) { //status
                            out.println(Helper.getButton("form-id-doBid", "input-id-doBid", "" + _dataTable.getOneCell(i, 0),
                                "Bid"));
                        }
                        ...
                        for (int j = 0; j < _dataTableBid.rowCount(); j++) {
                            ...
                            if (addCol2nd == 1) {
                                ...
                                if (_listActivity) {
                                    ...
                                    out.println(Helper.getButton("form-id-cancelBid", "input-id-cancelBid",
                                        _dataTableBid.getOneCell(j, 0) + "", "Cancel Bid"));
                                    out.println(Helper.getButton(
                                        "form-id-modifyBid", "input-id-modifyBid", _dataTableBid.getOneCell(j, 0) + "," +
                                        _dataTableBid.getOneCell(j, 1) + "," + _dataTableBid.getOneCell(j, 2),
                                        "Modify Bid"));
