...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td style='text-align: left'><label> <input
                    type='number' name='zipCode' value='' />
            </label></td>
        </tr>
        <tr>
            <td style='text-align: left'>Phone Number</td>
            <td style='text-align: left'><label for='phoneNumber'></label><input
                type='tel' id='phoneNumber' value=''
                placeholder='xxx-xxx-xxxx'
                pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' maxlength="12"></td>
        </tr>
        <tr>
