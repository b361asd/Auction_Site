        ...
        <tbody>
            ...
            if (dataTable.rowCount() > 0) {
                for (int i = 0; i < dataTable.rowCount(); i++) {
                    ...
                    out.println("<td>");
                    out.println(
                    Helper.getButton("form-deleteAlert", "input-deleteAlert", "" + dataTable.getOneCell(i, 0), "Dismiss"));
                    out.println(Helper.getButton("form-viewAlertDetail", "input-viewAlertDetail", "" + dataTable.getOneCell(i, 2)
                    + "," + ((dataTable.getOneCell(i, 3) == null) ? "" : dataTable.getOneCell(i, 3)), "Detail"));
                    out.println("</td>");
                    //
